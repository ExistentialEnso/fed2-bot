/**
 * This is a library that handles saving the logged information about the bot's runs
 */
...
/**
 * Loges the current balance of the player and the planet in balances.csv
 */
